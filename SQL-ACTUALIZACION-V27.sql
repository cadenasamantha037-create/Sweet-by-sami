-- Sweet by Sami · V27 · restricción de provincias en envíos nacionales
-- Ejecuta este archivo UNA VEZ sobre la base V26 actual.
...
-- Regla final: solo Cochabamba desbloquea destinos provinciales y solo admite
-- Ivirgarzama, Eterazama o Mariposas.
